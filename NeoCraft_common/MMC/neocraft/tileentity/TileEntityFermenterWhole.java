...
public class TileEntityFermenterWhole extends NCtileentity
{
	@Override public Class<? extends NCtileentity> getTileEntityClass() { return TileEntityFermenterWhole.class; }
