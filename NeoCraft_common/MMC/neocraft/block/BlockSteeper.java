...
public class BlockSteeper extends NCcontainerBlock
{
    ...
    public Icon getIcon(int par1, int par2)
    {
    	switch(par1)
    	{
    		case 1: case 2: return iconTop;
    		default:
    			if(par1 == (par2 & -2)) { return isActive ? iconFrontOn : iconFrontOff; }
    ...
    {
        this.iconSide = par1IconRegister.registerIcon("steeperSide");
        this.iconTop = par1IconRegister.registerIcon("steeperTop");
        this.iconFrontOff = par1IconRegister.registerIcon("steeperFrontOff");
        this.iconFrontOn = par1IconRegister.registerIcon("steeperFrontOn");
    }
    @Override
    ...
    {
        int direction = MathHelper.floor_double((double)(par5EntityLiving.rotationYaw * 4.0F / 360.0F) + 0.5D) & 3;
        
        switch(direction)
        {
        	case 0: par1World.setBlockMetadataWithNotify(par2, par3, par4, 2, 2); break;
        	case 1: par1World.setBlockMetadataWithNotify(par2, par3, par4, 5, 2); break;
        	case 2: par1World.setBlockMetadataWithNotify(par2, par3, par4, 3, 2); break;
        	case 3: par1World.setBlockMetadataWithNotify(par2, par3, par4, 4, 2); break;
        }
        /*
