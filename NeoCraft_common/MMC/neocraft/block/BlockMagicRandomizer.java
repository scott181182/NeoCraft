...
{
	private static boolean keepRandomizerInventory = false;
    ...
    public static void updateRandomizerBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
    	int meta = par1World.getBlockMetadata(par2, par3, par4);
        TileEntity tileentity = par1World.getBlockTileEntity(par2, par3, par4);
        keepRandomizerInventory = true;
    ...
    public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLivingBase par5EntityLiving, ItemStack par6ItemStack)
    {
        ...
        if(te != null) { ((TileEntityMagicRandomizer)te).setOrientation(facing); }
        if (par6ItemStack.hasDisplayName())
        {
            ((TileEntityMagicRandomizer)par1World.getBlockTileEntity(par2, par3, par4)).setCustomName(par6ItemStack.getDisplayName());
        }
    }
    ...
    {
        if (!keepRandomizerInventory)
        {
            TileEntityMagicRandomizer tileEntity = (TileEntityMagicRandomizer)par1World.getBlockTileEntity(par2, par3, par4);
