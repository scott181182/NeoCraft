...
public class SlotKilnSmeltery extends NCslot
{
	EntityPlayer player;
	private int expAmount;
	
	public SlotKilnSmeltery(EntityPlayer player, IInventory inv, int par1, int par2, int par3)
	{
    ...
    @Override protected void onCrafting(ItemStack par1ItemStack)
    {
        ...
        if (!this.player.worldObj.isRemote)
        {
            ...
            float exp = KilnSmelteryRecipes.smelting().getExperience(par1ItemStack);
            int j;
