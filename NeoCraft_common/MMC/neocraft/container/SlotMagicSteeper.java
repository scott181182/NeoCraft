...
public class SlotMagicSteeper extends NCslot
{
	EntityPlayer player;
	private int expAmount;
	public SlotMagicSteeper(EntityPlayer player, IInventory inv, int par1, int par2, int par3)
	{
    ...
    @Override protected void onCrafting(ItemStack par1ItemStack)
    {
        ...
        if (!this.player.worldObj.isRemote)
        {
            ...
            float exp = MagicSteeperRecipes.steeping().getExperience(par1ItemStack);
            int j;
