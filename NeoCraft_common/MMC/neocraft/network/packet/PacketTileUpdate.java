...
public class PacketTileUpdate extends NCpacket
{
    public int x, y, z;
    ...
    @Override public void execute(INetworkManager manager, Player player) 
    {
        NeoCraft.proxy.handleTileEntityPacket(x, y, z, ForgeDirection.getOrientation(orientation), state, customName);
    }
}
